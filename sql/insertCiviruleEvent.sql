...
VALUES
  ...
  ('new_contribution_soft', 'Contribution Soft is added', 'ContributionSoft', 'create', null,  CURDATE(), 1),
  ('changed_contribution_soft', 'Contribution Soft is changed', 'ContributionSoft', 'edit', null,  CURDATE(), 1),
  ('deleted_contribution_soft', 'Contribution Soft is deleted', 'ContributionSoft', 'delete', null,  CURDATE(), 1),
